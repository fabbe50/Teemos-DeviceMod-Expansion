package com.fabbe50.tcdme.handler;
...
/**
 * Created by fabbe on 24/12/2017 - 2:36 PM.
 */
public class RegistryHandler {
        ...
        public static void registerBlocks(final RegistryEvent.Register<Block> event) {
            ...
            for (final Block block : blocks) {
                if (block.getRegistryName() != null) {
                    ...
                    TCDME.getLogger().info("Successfully added block: " + block.getRegistryName().getResourcePath() + " to the game.");
                } else
                    TCDME.getLogger().warn("Tried to register block without registry name, ignoring.");
            }
        }
    ...
    public static class ItemRegistrationHandler {
        ...
        public static void registerItems(RegistryEvent.Register<Item> event) {
            ...
            for (Item item : items) {
                if (item.getRegistryName() != null) {
                    reg.register(item);
                    ITEM_LIST.add(item);
                    TCDME.getLogger().info("Successfully added item: " + item.getRegistryName().getResourcePath() + " to the game.");
                } else
                    TCDME.getLogger().warn("Tried to register item without registry name, ignoring.");
            }
        }
        ...
        private static void registerItemModel(Item item, int meta, String name) {
            registerItemModel(item, meta, new ModelResourceLocation(Reference.MODID + ":" + name, "inventory"));
        }
